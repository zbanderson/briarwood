...
(cite DecisionEngine), then explain the price picture and the biggest reason
for confidence or caution. Distinguish ask_price (listing) from all_in_basis
(the buyer's total committed dollars) when they differ. If a research_update line is
provided, include it verbatim — do not paraphrase it.
