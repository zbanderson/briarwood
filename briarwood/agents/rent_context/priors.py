...
_PRIORS: dict[tuple[str, str], RentPrior] = {
    ("belmar", "NJ"): RentPrior(
        ...
        confidence=0.36,
        base_monthly_rent_by_bed={2: 3000, 3: 3650, 4: 4400},
    ),
    ("bradley beach", "NJ"): RentPrior(
        ...
        confidence=0.35,
        base_monthly_rent_by_bed={2: 2850, 3: 3450, 4: 4150},
    ),
    ("avon by the sea", "NJ"): RentPrior(
        ...
        confidence=0.34,
        base_monthly_rent_by_bed={2: 3600, 3: 4450, 4: 5400},
    ),
    ("avon-by-the-sea", "NJ"): RentPrior(
        "Avon-by-the-Sea",
        "NJ",
    ...
    ("sea girt", "NJ"): RentPrior(
        ...
        confidence=0.34,
        base_monthly_rent_by_bed={2: 3500, 3: 4300, 4: 5200},
    ),
    ("spring lake", "NJ"): RentPrior(
        ...
        confidence=0.34,
        base_monthly_rent_by_bed={2: 3700, 3: 4550, 4: 5450},
    ),
    ("manasquan", "NJ"): RentPrior(
        ...
        confidence=0.35,
        base_monthly_rent_by_bed={2: 3200, 3: 3950, 4: 4750},
    ),
}
