"""Legacy runner: build the full analysis engine and run all modules.

This module contains the original "run everything" path that predates
the V2 intent-routed architecture. It is still the primary path for
the Dash UI, tear-sheet generation, and batch PDF export.
"""
...
from briarwood.runner_common import _prepare_property_input, validate_property_input
